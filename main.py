                    ...
                    <main class="row">
                        ...
                        <div class="col-6">
                            <form>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail" class="form-label">Ваш E-mail</label>
                                    <input type="email" class="form-control" id="exampleInputEmail">
                                </div>
                                <button type="submit" class="btn btn-success">Заказать звонок менеджера</button>
                            </form>
                        </div>
                    </main>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample1">
                                <div class="card card-body">
                                    Купите в один клик, нажав кнопку "Купить"!
                                </div>
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample3">
                                <div class="card card-body">
                                    На товар приобретенный у нас действует гарантия 6 месяцев! Но вы так же можете получить
                                    расширенную гарантию, учавствуя в акции "Год без забот!".
                                </div>
                            </div>
                        </div>
                    </div>
